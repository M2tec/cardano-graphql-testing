...
function loadQueryNode (name: string): Promise<DocumentNode> {
  return util.loadQueryNode(path.resolve(__dirname, '..', 'new', 'example_queries', 'scripts'), name)
}
...
describe('scripts', () => {
  ...
  it('can return an array of timelock scripts', async () => {
    ...
    util.saveResult(result.data, "new",   "scripts", "timelockScripts.json");
  ...
  it('can return an array of plutus scripts', async () => {
    ...
    util.saveResult(result.data, "new",   "scripts", "plutusScripts.json");
  ...
  it('can return aggregated data', async () => {
    ...
    util.saveResult(result.data, "new",   "scripts", "scriptsAggregate.json");

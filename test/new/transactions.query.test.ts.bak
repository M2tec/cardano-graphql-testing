...
function loadQueryNode (name: string): Promise<DocumentNode> {
  return util.loadQueryNode(path.resolve(__dirname, '..', 'new', 'example_queries', 'transactions'), name)
}
...
describe('transactions', () => {
  ...
  it('Returns transactions by hashes', async () => {
    ...
    util.saveResult(result.data, "new",   "transactions", "transactionsByHashesOrderByFee.json");
  ...
  it('Returns transactions by hashes with scripts', async () => {
    ...
    util.saveResult(plutusResult, "new",   "transactions", "transactionsByHashesOrderByFee_plutusResult.json");
    ...
    util.saveResult(timelockResult, "new",   "transactions", "transactionsByHashesOrderByFee_timelockResult.json");
  ...
  it('Can return ordered by block index', async () => {
    ...
    util.saveResult(result.data, "new",   "transactions", "orderedTransactionsInBlock.json");
  ...
  it('returns an empty array when the transactions has no outputs', async () => {
    ...
    util.saveResult(result.data, "new",   "transactions", "returns_an_empty_array_when_the_transactions_has_no_outputs.json");
  ...
  it('Can return aggregated data', async () => {
    ...
    util.saveResult(result.data, "new",   "transactions", "aggregateDataWithinTransaction.json");
  ...
  it('Can return filtered aggregated data', async () => {
    ...
    util.saveResult(result.data, "new",   "transactions", "filteredAggregateDataWithinTransaction.json");
  ...
  describe('metadata', () => {
    ...
    util.saveResult(result.data, "new",   "transactions", "transactionByIdWithMetadataIfPresent_1.json");
    ...
    it('JSON string', async () => {
      ...
      util.saveResult(result.data, "new",   "transactions", "transactionByIdWithMetadataIfPresent_2.json");
  ...
  describe('transactions with tokens', () => {
    it('shows the tokens minted and output', async () => {
      ...
      util.saveResult(result.data, "new",   "transactions", "transactionsByHashesWithTokens.json");
  ...
  describe('transactions with collateral', () => {
    it('shows the collateral inputs and outputs', async () => {
      ...
      util.saveResult(result.data, "new",   "transactions", "transactionsByHashesWithCollateral.json");
  ...
  describe('transactions with reference inputs', () => {
    it('shows the reference inputs', async () => {
      ...
      util.saveResult(result.data, "new",   "transactions", "transactionsByHashesWithReferenceInputs.json");

...
describe('transactions', () => {
  ...
  async function getTxHistory(address) {
    ...
    // curl -X POST "https://ar01a.gamechanger.finance:2083/postgrest/rpc/get_tx_history_for_addresses?limit=3&offset=0" \
    //      -H "Content-Type: application/json" \
    //      -d '{
    //            "data": {
    //              "addresses": ["addr_test1qzhk0pycq7g5krcl88dfly68r4d8v0qem66tfz0pv3gm284vtuft7q8490g8a8jq6f47sy87gvse82danhchjvjf3ucqsccj6p"]
    //            }
    //          }'

    try {
      const url = "https://ar01a.gamechanger.finance:2083/postgrest/rpc/get_tx_history_for_addresses?limit=3&offset=0";

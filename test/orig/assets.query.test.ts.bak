...
function loadQueryNode (name: string): Promise<DocumentNode> {
  return util.loadQueryNode(path.resolve(__dirname, '..', 'orig', 'example_queries', 'assets'), name)
}
...
describe('assets', () => {
  ...
  it('can return information on assets', async () => {
    ...
    util.saveResult(result.data, "orig", "assets", "assets_1.json");

    const { assets_aggregate, assets } = (result.data as any);
  ...
  it('can return information on assets by fingerprint', async () => {
    ...
    util.saveResult(result.data, "orig", "assets", "assets_2.json");
  ...
  it('can return information on assets by assetId', async () => {
    ...
    util.saveResult(result.data, "orig", "assets", "assets_3.json");

...
function loadQueryNode (name: string): Promise<DocumentNode> {
  return util.loadQueryNode(path.resolve(__dirname, '..', 'orig', 'example_queries', 'epochs'), name)
}
...
describe('epochs', () => {
  ...
  it('Returns epoch details by number', async () => {
    ...
    util.saveResult(result.data, "orig", "epochs", "epochDetailsByNumber.json");
  ...
  it('Includes protocol params in effect for the epoch', async () => {
    ...
    util.saveResult(result.data, "orig", "epochs", "epochProtocolParams.json");
  ...
  it('Can return aggregated data', async () => {
    ...
    util.saveResult(result.data, "orig", "epochs", "aggregateDataWithinEpoch.json");
  ...
  it('Can return filtered aggregated data', async () => {
    ...
    util.saveResult(result.data, "orig", "epochs", "numberOfBlocksProducedByLeaderInEpoch.json");
  ...
  it('Returns epoch details by number range', async () => {
    ...
    util.saveResult(result.data, "orig", "epochs", "epochDetailsInRange.json");
  ...
  it('Can return aggregated Epoch data', async () => {
    ...
    util.saveResult(result.data, "orig", "epochs", "aggregateEpochData.json");
  ...
  it('Returns blocks scoped to epoch', async () => {
    ...
    util.saveResult(validQueryResult.data, "orig", "epochs", "blocksInEpoch-valid.json");
    util.saveResult(invalidQueryResult.data, "orig", "epochs", "blocksInEpoch-invalid.json");
